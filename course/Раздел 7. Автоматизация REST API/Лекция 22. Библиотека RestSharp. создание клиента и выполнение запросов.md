...
{
    Timeout = TimeSpan.FromSeconds(30), // 30 секунд
...
**Валидация в автоматизированных тестах (xUnit):**
```csharp
[Fact]
public async Task GetUser_ValidId_ReturnsUserData()
{
    // Arrange
    var client = new RestClient(new RestClientOptions("https://jsonplaceholder.typicode.com"));
    var request = new RestRequest("users/1");
    ...
    Assert.Equal("Sincere@april.biz", response.Data.Email);
}
```
...
public class UserApiTests
{
    ...
    public UserApiTests()
    {
        _client = new RestClient(new RestClientOptions("https://jsonplaceholder.typicode.com"));
    }
