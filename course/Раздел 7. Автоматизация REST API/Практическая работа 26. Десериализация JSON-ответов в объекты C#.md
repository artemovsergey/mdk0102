...
namespace JsonDeserializationTests.Tests
{
    public class BasicDeserializationTests
    {
        ...
        public BasicDeserializationTests()
        {
        ...
        public void DeserializeUser_SystemTextJson_ShouldReturnValidObject()
        {
            ...
            Assert.Equal("Sincere@april.biz", user.Email);
        }
        ...
        public void DeserializeUsersList_SystemTextJson_ShouldReturnList()
        {
            ...
            Assert.False(string.IsNullOrEmpty(users[0].Name));
        }
        ...
        public void DeserializePosts_WithNestedProperties_ShouldWorkCorrectly()
        {
            ...
            Assert.True(firstPost.UserId > 0);
            Assert.False(string.IsNullOrEmpty(firstPost.Title));
            Assert.False(string.IsNullOrEmpty(firstPost.Body));
        }
        ...
        public void CompareSystemTextJsonAndNewtonsoft_ShouldProduceSameResults()
        {
            ...
            // Assert
            Assert.Equal(userNewtonsoft.Id, userSystemText.Id);
            Assert.Equal(userNewtonsoft.Name, userSystemText.Name);
            Assert.Equal(userNewtonsoft.Email, userSystemText.Email);
            Assert.Equal(userNewtonsoft.Username, userSystemText.Username);
        }
    }
}
```
...
namespace JsonDeserializationTests.Tests
{
    public class ComplexDeserializationTests
    {
        ...
        public ComplexDeserializationTests()
        {
        ...
        public void DeserializeComplexUser_WithNestedObjects_ShouldWorkCorrectly()
        {
            ...
            Assert.Equal("Kulas Light", user.Address.Street);
            Assert.Equal("Gwenborough", user.Address.City);
            Assert.NotNull(user.Address.Geo);
            Assert.Equal("-37.3159", user.Address.Geo.Lat);
            Assert.NotNull(user.Company);
            Assert.Equal("Romaguera-Crona", user.Company.Name);
        }
        ...
        public void DeserializeComplexUser_WithCustomConverter_ShouldParseDatesCorrectly()
        {
            ...
            Assert.Equal(2023, user.RegistrationDate.Year);
            Assert.Equal(1, user.RegistrationDate.Month);
            Assert.NotNull(user.LastLogin);
            Assert.Equal(2023, user.LastLogin.Value.Year);
        }
        ...
        public void DeserializePolymorphicObjects_ShouldUseDiscriminator()
        {
            ...
            Assert.Equal("admin", objects[0]["type"]);
            Assert.Equal("user", objects[1]["type"]);
        }
    }
}
```
...
2. **Установите необходимые NuGet пакеты** (xUnit, Newtonsoft.Json)
