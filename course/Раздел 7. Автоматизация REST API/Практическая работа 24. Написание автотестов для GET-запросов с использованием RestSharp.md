...
namespace RestSharpGetTests.Tests
{
    public class BasicGetTests
    {
        ...
        public BasicGetTests()
        {
            client = new RestClient(new RestClientOptions("https://jsonplaceholder.typicode.com"));
        }
        ...
        public void GetUser_ValidUserId_ReturnsCorrectUserData()
        {
            ...
            Assert.Equal("Bret", response.Data.Username);
        }
    }
}
```
...
namespace RestSharpGetTests.Tests
{
    public class DataDrivenGetTests
    {
        ...
        public void GetUsers_ReturnsListOfUsers()
        {
            ...
            Assert.True(response.Data[0].Id > 0);
        }
    }
}
```
...
1. **Создайте новый проект xUnit**: `dotnet new xunit -n RestSharpGetTests` (или Create .NET Project → xUnit Test Project в VS Code)
2. **Установите необходимые NuGet пакеты** (RestSharp 114.0.0, xUnit, etc.)
...
7. Как организовать параметризованные тесты в xUnit?
...
namespace RestSharpGetTests.Tests
{
    public class UserApiTests : IDisposable
    {
        ...
        public void GetAllUsers_ReturnsListOfUsers()
        {
            ...
            Assert.False(string.IsNullOrEmpty(firstUser.Name));
            Assert.False(string.IsNullOrEmpty(firstUser.Email));
        }
        ...
        public void GetUserTodos_ValidUserId_ReturnsTodos()
        {
            ...
            Assert.Equal(1, firstTodo.UserId);
            Assert.False(string.IsNullOrEmpty(firstTodo.Title));
        }
