...
Разработка комплексного тестового набора для REST API сервиса с использованием .NET, RestSharp и xUnit
...
namespace RestApiTestSuite.Services
{
    ...
    public class ApiClient : IApiClient
    {
        ...
        public ApiClient(AppSettings config)
        {
            ...
            {
                Timeout = TimeSpan.FromSeconds(config.ApiSettings.Timeout),
...
{
    // Фикстура уровня класса: создаётся один раз на весь тестовый класс
    public class TestFixture
    {
        public AppSettings Config { get; }
        public Logger Logger { get; }
        public TestDataGenerator TestData { get; }
...
namespace RestApiTestSuite.Tests
{
    // Ресурсы уровня теста создаются в конструкторе, освобождаются в Dispose()
...
namespace RestApiTestSuite.Tests.FunctionalTests
{
    ...
    public class PostTests : BaseTest, IClassFixture<TestFixture>
    {
        public PostTests(TestFixture fixture) : base(fixture) { }

        [Fact(DisplayName = "Получение всех постов должно возвращать статус 200 и непустой список")]
        ...
        [Fact(DisplayName = "Получение существующего поста по ID должно возвращать корректные данные")]
        ...
        [Fact(DisplayName = "Создание нового поста должно возвращать статус 201 и данные созданного поста")]
        ...
        [Fact(DisplayName = "Полное обновление поста должно возвращать обновленные данные")]
        ...
        [Fact(DisplayName = "Частичное обновление поста должно возвращать обновленные данные")]
        ...
        [Fact(DisplayName = "Удаление поста должно возвращать статус 200")]
        ...
        [Fact(DisplayName = "Получение постов по userId должно возвращать соответствующие посты")]
        ...
        [Fact(DisplayName = "Полный цикл CRUD операций для поста должен работать корректно")]
...
namespace RestApiTestSuite.Tests.FunctionalTests
{
    ...
    public class UserTests : BaseTest, IClassFixture<TestFixture>
    {
        public UserTests(TestFixture fixture) : base(fixture) { }

        [Theory(DisplayName = "Получение пользователя по валидным ID должно возвращать корректные данные")]
        ...
        [Fact(DisplayName = "Получение всех пользователей должно возвращать 10 пользователей")]
        ...
        [Fact(DisplayName = "Структура адреса пользователя должна быть корректной")]
        ...
        [Fact(DisplayName = "Структура компании пользователя должна быть корректной")]
...
namespace RestApiTestSuite.Tests.NegativeTests
{
    ...
    public class ErrorHandlingTests : BaseTest, IClassFixture<TestFixture>
    {
        public ErrorHandlingTests(TestFixture fixture) : base(fixture) { }

        [Fact(DisplayName = "Получение несуществующего поста должно возвращать 404")]
        ...
        [Theory(DisplayName = "Получение поста с некорректным ID должно обрабатываться корректно")]
        [InlineData(0)]
        [InlineData(-1)]
        ...
        [Fact(DisplayName = "Создание поста с невалидными данными должно обрабатываться корректно")]
        ...
        [Fact(DisplayName = "Обновление несуществующего поста должно возвращать 404")]
        ...
        [Fact(DisplayName = "Удаление несуществующего поста должно возвращать 404")]
...
namespace RestApiTestSuite.Tests.IntegrationTests
{
    ...
    [Trait("Category", "CrossEntity")]
    public class CrossEntityTests : BaseTest, IClassFixture<TestFixture>
    {
        public CrossEntityTests(TestFixture fixture) : base(fixture) { }

        [Fact(DisplayName = "Посты пользователя должны соответствовать пользователю")]
        ...
        [Fact(DisplayName = "Комментарии к посту должны соответствовать посту")]
        ...
        [Fact(DisplayName = "Альбомы пользователя должны соответствовать пользователю")]
        ...
        [Fact(DisplayName = "Фотографии в альбоме должны соответствовать альбому")]
...
namespace RestApiTestSuite.Tests.PerformanceTests
{
    ...
    [Trait("Category", "ResponseTime")]
    public class ResponseTimeTests : BaseTest, IClassFixture<TestFixture>
    {
        public ResponseTimeTests(TestFixture fixture) : base(fixture) { }

        private const int SlowThreshold = 1000; // ms

        [Fact(DisplayName = "Получение всех постов должно выполняться быстро")]
        ...
        [Fact(DisplayName = "Получение поста по ID должно выполняться быстро")]
        ...
        [Fact(DisplayName = "Создание поста должно выполняться быстро")]
...
Результаты тестов сохраняются в формате TRX и могут быть просмотрены в VS Code.
```
