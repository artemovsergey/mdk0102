...
Создайте папку `images` со скриншотом панели Testing (или вывода `dotnet test`), показывающим все успешно выполненные тесты, организованные по категориям с помощью Trait атрибутов.