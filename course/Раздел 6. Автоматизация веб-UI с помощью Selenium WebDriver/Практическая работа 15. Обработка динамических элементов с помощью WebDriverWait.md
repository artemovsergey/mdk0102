...
1. Создать **xUnit Test Project** на C# (`dotnet new xunit -n DynamicElementsTests`).
...
public void WaitForElementToBeClickable()
{
    ...
    Assert.Equal("Completed", resultText.Text);
}
```
...
public void FluentWaitExample()
{
    ...
    Assert.True(message.Displayed, "Сообщение не отображается");
}
```
