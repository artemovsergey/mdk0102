...
1. Создать **xUnit Test Project** на C# (`dotnet new xunit -n WaitComparisonTests`).
...
public class ImplicitWaitTests : IDisposable
{
    private readonly IWebDriver _driver;

    public ImplicitWaitTests()
    {
    ...
    public void TestImplicitWait()
    {
        ...
        Assert.True(dynamicElement.Displayed);
    }
...
public class ExplicitWaitTests : IDisposable
{
    private readonly IWebDriver _driver;
    private readonly WebDriverWait _wait;

    public ExplicitWaitTests()
    {
        _driver = new ChromeDriver();
        _driver.Manage().Window.Maximize();
        _driver.Navigate().GoToUrl("https://example.com/dynamic");
