...
**Files:**
- Rename: `course/Раздел 8. Интеграционное и нагрузочное тестирование/Лекция 23. Интеграционные тесты. Библиотека TestContainers для поднятия тестовой БД.md` → `…/Лекция 23. Интеграционные тесты. База данных на EF Core и SQLite.md`
